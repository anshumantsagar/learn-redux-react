...
import { increment, decrement, add, sub, storeResult, deleteResult } from '../../store/actions/actionTypes';
// we can offcourse call it like import * as actionCreators from '../../store/actions/actions';
